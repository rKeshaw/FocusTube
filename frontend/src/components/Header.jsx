...
// App bar: logo, Watch Later toggle, theme switcher.
// ============================================================
...
export default function Header({ onWatchLaterOpen, onSettingsOpen, watchLaterCount, onLogoClick }) {
